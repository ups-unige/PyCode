...
function(do_fetch)
  ...
  execute_process(
    COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
...
execute_process(
  COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git show-ref "master"
  WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
...
execute_process(
  COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/unige/PyCode/cmake/_deps/fmt-src'."
    ...
    execute_process(
      COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
    )
    execute_process(
      COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "E:/unige/PyCode/cmake/_deps/fmt-src"
      )
      execute_process(
        COMMAND "C:/Users/leonardo/scoop/shims/git.exe" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/unige/PyCode/cmake/_deps/fmt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
